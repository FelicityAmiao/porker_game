...
public class PorkerGame {
    public static int startGame(List<PorkerCard> totalCards) throws PorkerGameException {
        ...
        handleTotalCardsNumOverException(totalNum);
        handleSamePointHas4CardsAtMost(totalCards);
    ...
    private static void handleSamePointHas4CardsAtMost(List<PorkerCard> totalCards) throws PorkerGameException {
    ...
    private static void handleTotalCardsNumOverException(int totalNum) throws PorkerGameException {
